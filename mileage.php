...
<body>
  ...
  <nav class="mobile-nav">
    <a href="dashboard.php" class="nav-item"><i class="ph ph-house" class="mobile-nav-labels"></i>Home</a>
    <a href="assigned_vehicle.php" class="nav-item"><i class="ph ph-truck" class="mobile-nav-labels"></i>Specs</a>
    <a href="mileage.php" class="nav-item active"><i class="ph ph-speedometer" class="mobile-nav-labels"></i>Odo</a>
    <a href="maintenance_reminders.php" class="nav-item"><i class="ph ph-bell" class="mobile-nav-labels"></i>Alerts</a>
  </nav>
